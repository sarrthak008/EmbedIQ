    ...
    <div className="min-h-screen text-[#1a1a1a] font-sans selection:bg-black selection:text-white relative">
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-[500] flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="relative bg-white w-full max-w-md rounded-[32px] overflow-hidden shadow-2xl border border-gray-100 animate-in zoom-in-95 duration-200">
            ...
            <div className="p-10 relative z-10">
              ...
              <h3 className="text-3xl font-bold tracking-tighter mb-3 text-red-600">
                Decommission
              </h3>

              <p className="text-gray-500 mb-8 leading-relaxed font-medium">
                Are you sure you want to terminate <span className="text-black font-bold">{activeBot?.bot_name}</span>?
                This action is irreversible and will purge all neural data.
              </p>

              <div className="flex gap-4">
                <button
                  onClick={() => setIsDeleteModalOpen(false)}
                  className="flex-1 py-4 bg-gray-100 hover:bg-gray-200 text-black text-[10px] font-black rounded-2xl transition-all tracking-[0.2em] uppercase"
                >
                  Cancel
                </button>
                <button
                  onClick={handleDelete}
                  className="flex-1 py-4 bg-red-600 text-white hover:bg-red-700 text-[10px] font-black rounded-2xl transition-all tracking-[0.2em] uppercase shadow-lg shadow-red-200"
                >
                  Confirm
                </button>
              </div>
