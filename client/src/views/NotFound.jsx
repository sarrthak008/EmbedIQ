...
const NotFound = () => {
  return (
    <div className='bg-black h-screen w-screen flex flex-col items-center justify-center'>
      <StyledWrapper className='w-[500px] h-[400px]'>
    ...
    <h2 className='text-white flex items-center gap-3 text-xl justify-center cursor-pointer' onClick={()=>window.location = "/"}><MoveLeftIcon size={15}/> go home</h2>
    </div>
  );
}
